 ...
 */
/* Change the shell command in config.h */
static char *shell = "/bin/sh -c 'cd'";
char *utmp = NULL;
...
const char *background = "#1a1b26";
const char *foreground = "#c0caf5";
...
static const int usealpha = 1;           /* Use transparency */
static const unsigned int alpha = 0xcc;  /* 80% opacity (0x00-0xff) */
/*
